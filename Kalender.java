...
public class Kalender {
    ...
    public static String datum(){
        String datumNu = Calendar.getInstance().getTime().toString();
        String år = datumNu.substring(24, 28);
        String månad = datumNu.substring(4, 7);
        String dag = datumNu.substring(8,11);
